...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mMuhammad moshin█████████████████▒▒▒▒▒▒▒▒..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
while (loop == 'true'):
    ...
    if (passcode == CorrectPasscode):
            print """
            \033[1;92mWelcome MUHAMMAD MOSHIN TOOL
               """
            loop = 'false'
    else:
...
\033[1;91mThanks \033[1;97mUseing My cloning tool  ThankS
\033[1;92m MY FACEBOOK\033[1;97m@MUHAMMAD MOSHIN
\033[1;93mGitHub\033[1;97mIRTAZAHA
\033[1;94WHATSAPP\033[1;97m+923254985137"""
